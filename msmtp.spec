...
Source0  : https://marlam.de/msmtp/releases/msmtp-1.8.26.tar.xz
Source1  : https://marlam.de/msmtp/releases/msmtp-1.8.26.tar.xz.sig
...
%setup -q -n msmtp-1.8.26
cd %{_builddir}/msmtp-1.8.26
pushd ..
cp -a msmtp-1.8.26 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714571757
