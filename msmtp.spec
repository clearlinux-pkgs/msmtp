...
Source0  : https://marlam.de/msmtp/releases/msmtp-1.8.24.tar.xz
Source1  : https://marlam.de/msmtp/releases/msmtp-1.8.24.tar.xz.sig
...
%prep
%setup -q -n msmtp-1.8.24
cd %{_builddir}/msmtp-1.8.24
pushd ..
cp -a msmtp-1.8.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688136746
